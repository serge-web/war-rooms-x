...
const WargameProviderDecorator = (Story: React.ComponentType, { parameters }: { parameters?: { wargame?: { gameState?: Partial<GameStateType>, gameProperties?: Partial<GamePropertiesType> } } }) => {
